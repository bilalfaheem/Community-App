...
class BillingStatus extends StatelessWidget {
  bool paid;
  String text;
  final picture;
  final colorr;
                          ...
                          children: <InlineSpan>[
                            TextSpan(
                              text: paid
                                  ? "PAID"
                                  : billingData!
                                      .data!.bill!.duesBillData!.dueAmount
                                      .toString(),
                              style: TextStyle(
                                  fontSize: 18.sp,
                                  fontWeight: FontWeight.w500,
                      ...
                      Text.rich(TextSpan(
                          ...
                          children: <InlineSpan>[
                            TextSpan(
                              text: paid
                                  ? Utils.dateFormat1(
                                      "${billingData!.data!.dueDate!.paidDate}T10:35:46.000000Z")
                                  : Utils.dateFormat1(
                                      "${billingData!.data!.dueDate!.dueDate}T10:35:46.000000Z"),
                              style: TextStyle(
                                  fontSize: 18.sp,
                                  fontWeight: FontWeight.w500,
                                  color: Color.fromARGB(131, 218, 220, 222)),
