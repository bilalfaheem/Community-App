...
class VersionCheckViewModel with ChangeNotifier {
  ...
  Future<void> fetchversionCheckResponse(BuildContext context, Map data) async {
    ...
    _versionCheckRepo.fetchVersionCheckApi(data).then((value) {
      ...
      if (value.data!.status == 0) {
        navigate(
            context, UpdateAlert(forced: value.data!.versionMode == "force",content: value.data!.message.toString(),appLink: value.data!.appLink.toString(),));
      }
